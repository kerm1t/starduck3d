...
/*
  void Initial_MVP_Upload() // das wird auch im Render gemacht, hier doppelt?
  {
    GLenum err = glGetError();
    ...
    glUniformMatrix4fv(sh1_unif_MVPMatrix, 1, GL_FALSE, &MVPMatrix[0][0]); // load matrix into shader
    err = glGetError();
  }
*/
  void InitShader2()
